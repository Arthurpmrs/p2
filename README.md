...
- User Roles and Permissions
    ...
    - Dono do site pode dar permissão de gerência para outros usuários.
- Content Creation and Editing
    - Usuários gerentes de um Site podem criar Posts no Site.
...
- Media Library Management
    ...
    - Usuários gerentes de um Site podem fazer "upload" de mídias para a biblioteca e essas mídias podem ser incluídas em um Post.
- Content Scheduling
    - Ao criar um Post, o usuário tem a opção de agendar um Post para exibição.
    - Um post agendado (cuja data alvo ainda não chegou) não aparece na listagem de Posts do Site.
- Analytics and Reporting
    - É possível ver estatísticas de acesso e interação para um Site (apenas os gerentes podem ver), que incluem número de acessos, número de mídias importadas, número de posts criados.
    - É possível ver estatísticas de cada Post (apenas os gerentes podem ver), que incluem número de visualizações, número de comentários e número de compartilhamentos.
...
- Multi-Language Support
    - Os gerentes de um site têm a opção de escolher a linguagem em que o Post será escrito.
    - Os gerentes de um site podem adicionar uma tradução a um Post existente.
